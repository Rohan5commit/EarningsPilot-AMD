...
def chat(req: ChatRequest, authorization: Optional[str] = Header(default=None)):
    ...
    max_new_tokens = int(req.max_tokens or MAX_NEW_TOKENS_DEFAULT)
...
export BASE_MODEL ADAPTER_PATH SERVED_MODEL_NAME API_KEY MAX_MODEL_LEN MAX_NEW_TOKENS_DEFAULT ENABLE_LORA HOST PORT
